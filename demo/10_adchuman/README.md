...
炫彩板人体传感器对应核心板GPIO12(ADC5)

## 二、如何编译

1. 将10_adchuman目录复制到openharmony源码的`applications\sample\wifi-iot\app`目录下，
...
烧录文件后，按下reset按键，程序开始运行，用手划过炫彩灯板上的人体传感器，串口会打印一段时间的高电平数值，然后输出低电平数值。
