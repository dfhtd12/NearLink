...
static void OnButtonPressed(char *arg)
{
    ...
    sle_uart_server_send_report_by_handle(&led_flag,1);
}


    Button_GPIO_Init(){
    IoTGpioInit(IOT_GPIO_BUTTON);
    IoSetFunc(IOT_GPIO_BUTTON,0);
    IoTGpioSetDir(IOT_GPIO_BUTTON, IOT_GPIO_DIR_IN);
    IoSetPull(IOT_GPIO_BUTTON, IOT_IO_PULL_UP);
    IoTGpioRegisterIsrFunc(IOT_GPIO_BUTTON, IOT_INT_TYPE_EDGE, IOT_GPIO_EDGE_FALL_LEVEL_LOW,
